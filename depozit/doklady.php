...
?>
  <tr class="hlavicka">
    <td colspan="2" class="right">Pokladňa:</td>
  ...
  <tr class="hlavicka">
    <td colspan="2" class="right">Banka:</td>
...
?>
  <tr>
    <td colspan="2" class="left">Číslo dokladu:&nbsp &nbsp &nbsp <b><?php echo $doklad_cislo;?></b></td>
    <td class="right">Kód:</td>
    <th colspan="3" class="left"><?php echo $row['kod'].' - '.$_SESSION['kody'.$row['kod']];?></th><!-- kód -->
  </tr>
