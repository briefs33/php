...
class MYPDF extends TCPDF{
  ...
  public function Header(){
    ...
    $this->Cell(0,15,'Pohyby pokladne a banky',1,0,'C',0,'',0,false,'M','M'); //Title
...
$pdf->SetTitle('Pohyby pokladne a banky');
...
$w=array(20,45,25,10,20,20,25,25);
...
if(mysqli_num_rows($run)>0){
  while($row=mysqli_fetch_array($run)){
    ...
    if($dat!=$row['datum_uctovania']){
      ...
      if($riadok>0){
        ...
        $pdf->MultiCell(/*w*/$w[0]+$w[1]+$w[2]+$w[3],/*h*/5,/*txt*/'Pokladňa:',/*border*/0,/*align*/'R',/*fill*/0,/*ln*/0,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
        $pdf->SetFont('freeserif','',12);
        $pdf->MultiCell(/*w*/$w[4],/*h*/5,/*txt*/number_format($spolu_prijem_pokladna,2,',',''),/*border*/1,/*align*/'R',/*fill*/1,/*ln*/0,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
        $pdf->MultiCell(/*w*/$w[5],/*h*/5,/*txt*/number_format($spolu_vydaj_pokladna,2,',',''),/*border*/1,/*align*/'R',/*fill*/1,/*ln*/0,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
        $pdf->MultiCell(/*w*/$w[6],/*h*/5,/*txt*/number_format($pokladna,2,',',''),/*border*/1,/*align*/'R',/*fill*/1,/*ln*/0,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
        $pdf->MultiCell(/*w*/$w[7],/*h*/5,/*txt*/'',/*border*/1,/*align*/'R',/*fill*/1,/*ln*/1,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);

        $pdf->SetFont('freeserif','B',12);//set font
        $pdf->MultiCell(/*w*/$w[0]+$w[1]+$w[2]+$w[3],/*h*/5,/*txt*/'Banka:',/*border*/0,/*align*/'R',/*fill*/0,/*ln*/0,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
        $pdf->SetFont('freeserif','',12);
        $pdf->MultiCell(/*w*/$w[4],/*h*/5,/*txt*/number_format($spolu_prijem_banka,2,',',''),/*border*/1,/*align*/'R',/*fill*/1,/*ln*/0,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
        $pdf->MultiCell(/*w*/$w[5],/*h*/5,/*txt*/number_format($spolu_vydaj_banka,2,',',''),/*border*/1,/*align*/'R',/*fill*/1,/*ln*/0,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
        $pdf->MultiCell(/*w*/$w[6],/*h*/5,/*txt*/'',/*border*/1,/*align*/'R',/*fill*/1,/*ln*/0,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
        $pdf->MultiCell(/*w*/$w[7],/*h*/5,/*txt*/number_format($banka,2,',',''),/*border*/1,/*align*/'R',/*fill*/1,/*ln*/1,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
  ...
  //  }
      $pdf->SetFont('freeserif','B',12);//set font
      $pdf->MultiCell(/*w*/$w[0]+$w[1],/*h*/5,/*txt*/'Dátum účtovania: '.date('j.n.Y', strtotime($row['datum_uctovania'])),/*border*/0,/*align*/'L',/*fill*/0,/*ln*/0,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
      $pdf->MultiCell(/*w*/$w[2],/*h*/5,/*txt*/'Pokladňa:',/*border*/0,/*align*/'L',/*fill*/0,/*ln*/0,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
      $pdf->MultiCell(/*w*/$w[3]+$w[4],/*h*/5,/*txt*/number_format($pokladna,2,',',''),/*border*/0,/*align*/'R',/*fill*/0,/*ln*/0,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
      $pdf->MultiCell(/*w*/$w[5],/*h*/5,/*txt*/'',/*border*/0,/*align*/'L',/*fill*/0,/*ln*/0,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
      $pdf->MultiCell(/*w*/$w[6],/*h*/5,/*txt*/'Banka:',/*border*/0,/*align*/'L',/*fill*/0,/*ln*/0,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
      $pdf->MultiCell(/*w*/$w[7],/*h*/5,/*txt*/number_format($banka,2,',',''),/*border*/0,/*align*/'R',/*fill*/0,/*ln*/1,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
    ...
    $pdf->MultiCell(/*w*/$w[1],/*h*/5,/*txt*/substr($row['priezvisko'].' '.$row['meno'],0,24),/*border*/1,/*align*/'L',/*fill*/0,/*ln*/0,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
    $pdf->MultiCell(/*w*/$w[2],/*h*/5,/*txt*/$doklad_cislo,/*border*/1,/*align*/'R',/*fill*/0,/*ln*/0,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
    $pdf->MultiCell(/*w*/$w[3],/*h*/5,/*txt*/$row['kod'],/*border*/1,/*align*/'C',/*fill*/0,/*ln*/0,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
    $pdf->MultiCell(/*w*/$w[4],/*h*/5,/*txt*/number_format($prijem,2,',',''),/*border*/1,/*align*/'R',/*fill*/0,/*ln*/0,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
    $pdf->MultiCell(/*w*/$w[5],/*h*/5,/*txt*/number_format($vydaj,2,',',''),/*border*/1,/*align*/'R',/*fill*/0,/*ln*/0,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
    $pdf->MultiCell(/*w*/$w[6],/*h*/5,/*txt*/number_format($pokladna,2,',',''),/*border*/1,/*align*/'R',/*fill*/0,/*ln*/0,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
    $pdf->MultiCell(/*w*/$w[7],/*h*/5,/*txt*/number_format($banka,2,',',''),/*border*/1,/*align*/'R',/*fill*/0,/*ln*/1,/*x*/'',/*y*/'',/*reseth*/true,/*stretch*/0);
...
$pdf->SetFont('freeserif','B',12);//set font
$pdf->Ln(2); //Line break
$pdf->Cell(10,5,'Kód:',0,1);
$pdf->SetFont('freeserif','',12);//set font
for($x=1;$x<10;$x++){
  $pdf->Cell(10,5,$x.' - '.$_GET['kod_'.$x],0,1);
}
